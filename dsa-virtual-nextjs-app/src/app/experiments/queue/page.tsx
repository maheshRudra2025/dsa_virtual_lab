...
export default function QueueExperiment() {
  ...
  useEffect(() => {
    ...
    const loadScripts = async () => {
      ...
      try {
        ...
        await loadScript("/lib/algorithms/QueueLL.js");
    ...
    const initializeVisualization = () => {
      try {
        console.log("Initializing queue visualization...");
        ...
        if (typeof (window as any).QueueLL !== "function") {
          console.error("QueueLL constructor not found");
          return;
        }
